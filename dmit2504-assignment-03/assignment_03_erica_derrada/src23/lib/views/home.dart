          ...
          Expanded(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, i) {
                  return Card(
                    child: ListTile(
                      title: Text('Symbol: ${stockList[i]['symbol']}',
                          style: TextStyle(fontSize: 30)),
                      subtitle: Text('Name: ${stockList[i]['name']}',
                          style: TextStyle(fontSize: 20)),
                      trailing: Text('Price: ${stockList[i]['price']}',
                          style: TextStyle(fontSize: 20)),
                    ),
                  );
                }),
                ...
                onPressed: () async {
                  if (stockSymbol.isNotEmpty) {
                    ...
                    try {
                      ...
                      Map<String, dynamic>? companyData = await stockService
                      ...
                      if (companyData == null) {
                        ...
                        if (companyQuote == null) {
                          ...
                          price = companyQuote["Global Quote"]["05. price"];
